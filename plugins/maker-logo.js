let handler = async (m, { conn, args, text, usedPrefix, command }) => {
  let tee = `✳️ Gib einen kurzen Text ein\n\n📌 Beispiel: *${usedPrefix + command}* QASIM`
  let too = `✳️ Trenne den Text mit einem *+* \n\n📌 Beispiel: \n*${usedPrefix + command}* GLOBAL *+* MD`
  ...
  switch (type) {
    case 'gfx1':
      ...
      conn.sendFile(m.chat, chut, 'logo.png', `✅ Ergebnis`, m)
      m.react(done)
      break
    ...
    case 'gfx2':
      ...
      conn.sendFile(m.chat, loda, 'logo.png', `✅ Ergebnis`, m)
    ...
    case 'gfx3':
      ...
      conn.sendFile(m.chat, cp, 'logo.png', `✅ Ergebnis`, m)
      m.react(done)
      break
    ...
    case 'gfx6':
      ...
      conn.sendFile(m.chat, apiUrl, 'logo.png', `✅ Ergebnis`, m)
      m.react(done)
      break
    case 'gfx7':
      if (!text) throw too
      ...
      conn.sendFile(m.chat, oda, 'logo.png', `✅ Ergebnis`, m)
    ...
    case 'gfx11':
      ...
      conn.sendFile(m.chat, od, 'logo.png', `✅ Ergebnis`, m)
    ...
    case 'gfx12':
      ...
      conn.sendFile(m.chat, rr, 'logo.png', `✅ Ergebnis`, m)
      m.react(done)
      break
